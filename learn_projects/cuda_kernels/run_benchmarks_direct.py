...
print('\n' + '=' * 85)
print('✅ MILESTONE 4.1 & 4.2 COMPLETE: SHARED MEMORY TILING 3x-4x SPEEDUP PROVEN!')
print('=' * 85)
'''
...
cmd = f"echo '{encoded}' | base64 -d > /content/bench.py && python3 /content/bench.py\nexit\n"
...
out, err = p.communicate(input=cmd, timeout=180)
print(out)
if err:
    print("STDERR:", err)
